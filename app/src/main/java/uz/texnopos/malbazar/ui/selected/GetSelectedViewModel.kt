...
class GetSelectedViewModel(private val api: ApiInterface) : ViewModel() {
    ...
    private var _getSelectedAnimals: MutableLiveData<Resource<Any>> = MutableLiveData()
    val getSelectedAnimals: MutableLiveData<Resource<Any>> get() = _getSelectedAnimals
